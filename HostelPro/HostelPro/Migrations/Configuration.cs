namespace HostelPro.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HostelPro.Models.MasterData>
    {
        ...
        protected override void Seed(HostelPro.Models.MasterData context)
        {
            ...
            context.Hostels.AddOrUpdate(new Hostel { ID = hostelId, Address = "Havnegade 20", Phone = 86192055, CityId = cityId, Email = "sleep-in@citysleep-in.dk", Information = "På Aarhus Hostel får du overnatninger på en tidligere højskole. Her får du i en god atmosfære BILLIG overnatning tæt på Aarhus" });
