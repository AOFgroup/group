...
namespace mvcMany.Controllers
{
    ...
    {
        private mvcManyContext db = new mvcManyContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Name")] Accommodation accommodation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name")] Accommodation accommodation)
        {
            if (ModelState.IsValid)
            {
